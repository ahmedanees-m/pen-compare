...
Applies the 5 TrueWriterScore gates per pen_compare/config/gates_v3.yaml (pre-registered).
...
from pen_compare.core.gates import (
    GateResult,
    GateRole,
    gate_1_dsb,
...
def certify(
    ...
    # Threshold overrides for sensitivity analysis
